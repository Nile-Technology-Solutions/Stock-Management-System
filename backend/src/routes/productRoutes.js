...
router.post('/', authMiddleware, roleMiddleware(ADMIN_ROLES), validateFinishedProduct, productController.createProduct);

// PUT /api/products/:id - Update a finished product
router.put('/:id', authMiddleware, roleMiddleware(ADMIN_ROLES), validateIdParam, validateFinishedProductUpdate, productController.updateProduct);

// DELETE /api/products/:id - Delete a finished product
router.delete('/:id', authMiddleware, roleMiddleware(ADMIN_ROLES), validateIdParam, productController.deleteProduct);
