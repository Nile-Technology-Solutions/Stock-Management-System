        ...
        <GlassCard variant="standard" className="h-full">
          ...
          <div className="space-y-4 max-h-96 overflow-y-auto">
            {recentActivities.map((activity, idx) => (
              <div key={activity.id || idx} className="flex items-start gap-4 p-4 bg-white/30 dark:bg-slate-800/30 rounded-xl hover:bg-white/50 dark:hover:bg-slate-800/50 transition-all duration-200 group">
        ...
        <GlassCard variant="standard">
          ...
          <div className="space-y-4">
            {topProducts.map((product, index) => (
              <div key={product.id || index} className="flex items-center gap-3 p-3 bg-white/30 dark:bg-slate-800/30 rounded-lg hover:bg-white/50 dark:hover:bg-slate-800/50 transition-all duration-200 group">
                <div className="relative">
                  <img 
                    src={product.image || 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=60&h=60&fit=crop'} 
                    alt={product.name}
