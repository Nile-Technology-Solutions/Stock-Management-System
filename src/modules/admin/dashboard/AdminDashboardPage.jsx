...
import { getDashboardData } from '../../../modules/core/dashboard/dashboardService';
...
const AdminDashboardPage = () => {
  ...
  const loadDashboardData = async () => {
    // Load dashboard data for Admin role (no revenue stats)
    const data = await getDashboardData(selectedTimeRange);
